...
def create_books_read_summary(conn):
    ...
    hours = df_books["Total Time Spent"] / (1000 * 60 * 60)
    df_books["Average Reading Speed (pages/hour)"] = (df_books['Total Pages Read'] * 3600) / df_books["Total Time (raw units)"].round(2)
